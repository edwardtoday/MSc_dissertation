...
%
% There you will be able to make a small donation 
% ( just 2 Euros, less than 2.8 US Dollars ) using
% the secure connection to PayPal.
%
% The source code implements FingerCode-based fingerprint 
% verification. 
%
% References:
% 
